...
import { zipUrl, formatSize, iconMarkup } from "./index";
...
<div class="page-head cardhead">${iconMarkup(a, "lg")}<div>
<h2>${e(a.name)} <span class="meta">v${e(a.version)}</span></h2>
<p class="row"><span class="pill">${e(a.category)}</span><span>by ${e(a.author)}</span><span>★ ${a.stars}</span></p></div></div>
<div class="detail">
<div>
...
<h3 style="margin-top:16px">SHA-256 of the ZIP</h3>
