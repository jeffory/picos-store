...
${debug.rejected.length ? `<div class="scroll"><table><thead><tr><th>Repository</th><th>Reason</th></tr></thead><tbody>${rows}</tbody></table></div>` : `<p class="empty">No repositories were rejected.</p>`}
