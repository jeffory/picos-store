...
<div class="actions"><a class="btn" href="${e(zipUrl(a))}">Download ZIP · ${formatSize(a.size_kb)}</a><a class="btn secondary" href="${e(repoUrl)}">Source on GitHub</a>${showHomepage ? `<a class="btn secondary" href="${e(homepageUrl)}">Homepage</a>` : ""}</div>
...
<dt>SHA-256</dt><dd><code class="hash">${e(a.sha256)}</code><button id="copy" class="copy" type="button" data-hash="${e(a.sha256)}" hidden>Copy</button></dd>
</dl>
</div>
</div>`;
  return renderPage({ title: `${a.name} · PicOS App Store`, description: a.description, body, script: SCRIPT });
}
